        ...
        <div className="main-container">
          {
            ...
            <button className='DeleteButton2' onClick={handleDeletePin}>Delete Pin</button>
          }
          ...
          {(isThisInBoardArray.length !== 0)
            ?
            <div >
              <button onClick={deleteThisSave} className='singlePageCenterRight1Button'>Unsaved</button>
            </div>
            :
            <div >
              <button onClick={saveThisPin} className='singlePageCenterRight1Button'>Save</button>
            </div>
          }
        </div>
