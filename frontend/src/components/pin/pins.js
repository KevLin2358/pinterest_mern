...
function Pins() {
    ...
    console.log(img.src)
    if (img.width < 150) console.log(img.width)
    else if (img.height/img.width <= 1.2) {
        return (
            <div className='card card_small' onClick={()=>window.location.href = img.src}>
    ...
    // }
        ...
        return (
            <div className='card card_medium' onClick={()=>window.location.href = img.src}>
                <img style={{width:"100%",height:"100%"}} src={img.src} alt="testing"></img>
